package Ej3_strategy;

public class Client {
    public static void main(String[] args) {
        Tienda tienda = new Tienda();
        tienda.addCelular(new Celular("nokia","new","new",1900)).addCelular(new Celular("oso","new","new",180))
        .addCelular(new Celular("apple","new","new",230)).addCelular(new Celular("gato","new","new",150))
        .addCelular(new Celular("samsung","new","new",500)).addCelular(new Celular("ganso","new","new",150));
